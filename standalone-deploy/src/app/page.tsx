          ...
          <div className="flex justify-between items-center">
            ...
            >
              <button 
                ...
                className="hidden sm:block px-6 py-2.5 bg-gradient-to-r from-green-600 to-green-700 text-white rounded-xl hover:from-green-700 hover:to-green-800 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 cursor-pointer font-medium"
              >
                Sign In
              </button>
          ...
          {isMobileMenuOpen && (
            ...
            >
              <div className="flex flex-col space-y-4">
                ...
                <button 
                  onClick={() => window.location.href = '/matches'}
                  className="w-full px-6 py-2.5 bg-gradient-to-r from-green-600 to-green-700 text-white rounded-xl hover:from-green-700 hover:to-green-800 transition-all duration-300 shadow-lg hover:shadow-xl font-medium"
                >
                  Sign In
                </button>
              </div>
      ...
      <div className="container mx-auto px-4">
        ...
        <section className="py-20 text-center">
          ...
          >
            ...
            >
              <button 
                onClick={() => window.location.href = '/matches'}
                className="group px-8 py-4 bg-gradient-to-r from-green-600 to-green-700 text-white text-lg rounded-2xl hover:from-green-700 hover:to-green-800 transition-all duration-300 shadow-xl hover:shadow-2xl transform hover:-translate-y-1 cursor-pointer font-semibold flex items-center space-x-2"
              >
        ...
        <section className="py-20">
          ...
          >
            ...
            <button 
              onClick={() => window.location.href = '/matches'}
              className="px-8 py-4 bg-white text-green-600 text-lg rounded-2xl hover:bg-gray-50 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 cursor-pointer font-semibold"
            >
