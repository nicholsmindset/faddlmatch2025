...
const MOCK_PROFILES = [
  {
    ...
    photos: [{ url: '/api/placeholder/400/600', visibility: 'public' }],
    bio: 'Practicing Muslim software engineer seeking a righteous wife for marriage. I enjoy technology, reading Quran, and spending time with family.',
