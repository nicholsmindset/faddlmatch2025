    ...
    <main className="min-h-screen bg-gradient-to-br from-green-50 to-yellow-50">
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-8">
          <h4 className="text-lg font-semibold text-blue-900 mb-2">🚧 Development Mode</h4>
          <p className="text-blue-800">
            This is a simplified version for local development. The full application includes:
          </p>
          <ul className="list-disc list-inside text-blue-800 mt-2 space-y-1">
            ...
            <li>Guardian Oversight Features</li>
            <li>Islamic Compliance Tools</li>
          </ul>
        </div>

        {/* Available Pages */}
        <div className="bg-gray-50 rounded-lg p-6 mb-8">
          <h4 className="text-lg font-semibold text-gray-900 mb-4">📄 Available Pages (Demo)</h4>
          <div className="grid md:grid-cols-2 gap-4">
            <div>
              <h5 className="font-medium text-gray-900 mb-2">Public Pages:</h5>
              <ul className="space-y-1 text-gray-600">
                <li>• Homepage (current)</li>
                <li>• About Page</li>
            ...
            <div>
              <h5 className="font-medium text-gray-900 mb-2">Authenticated Pages:</h5>
              <ul className="space-y-1 text-gray-600">
                <li>• Dashboard</li>
                <li>• Matches Browser</li>
                <li>• Messaging Interface</li>
                <li>• Profile Management</li>
                <li>• Guardian Portal</li>
              </ul>
            </div>
          </div>
        </div>
